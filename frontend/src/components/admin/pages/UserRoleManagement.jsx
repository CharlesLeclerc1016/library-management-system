...
const UserRoleManagement = ({ currentUserId, onNotify }) => {
  const { query, data, loading, setRole, setKeyword, setPage, updateRole, resetPassword } = useUsers()
